...
## Layer-by-Layer Table (Row Counts & Steps)

| Layer     | Key Tables      | Row Counts                | Major Processing Steps Between Layers                    |
|-----------|----------------|---------------------------|----------------------------------------------------------|
| Bronze    | 7 base tables   | 70k–126k (as loaded)      | Raw ingest, no cleaning                                  |
| Silver    | 7 cleansed      | 7k–69k (facts); 7–9 (dims)| Remove orphans, parse columns, dedupe, map codes/labels  |
| Gold      | 5 dims + 3 facts| Dims: 7–69k;    Facts: hires/departs: 7–69k, snapshots: ~12.5M | Build star schema, generate surrogate keys, join labels  |
| Reporting | View            | N/A                       | Monthly/agg queries feeding only actual Tableau visuals  |
```
