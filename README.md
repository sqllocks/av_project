...
| dept_emp.csv | Orphan Records | No corresponding employee | Poor referential integrity | 97305.0 |
| dept_emp.csv | Orphan Records | Assignments for non-existent employees or departments | Poor referential integrity | 151.0 |
| dept_manager.csv | Orphan Records | emp_no may not map to reference tables | Integrity of org chart is at risk | 17.0 |
...
| departments.csv | Duplicate values | Employees assigned to multiple departments simultaneously | Inability to tie a record to a specific department | 12033.0 |
